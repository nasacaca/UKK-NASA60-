        ...
        @forelse($bukus as $buku)
            <div class="col-sm-6 col-lg-4 col-xl-3">
                <div class="card h-100" style="transition:transform 0.2s,box-shadow 0.2s;"
                    onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 8px 24px rgba(21,101,192,0.12)'"
                    onmouseout="this.style.transform='';this.style.boxShadow=''">
                    {{-- Cover --}}
                    <div
                        style="height:250px;background:linear-gradient(135deg,#1565C0,#42A5F5);border-radius:16px 16px 0 0;display:flex;align-items:center;justify-content:center;position:relative;">
                        @if($buku->cover)
                    ...
                    <div class="card-body d-flex flex-column p-10">
                        <span class="badge mb-2"
                            style="background:#EEF2FF;color:#3949AB;width:fit-content;">{{ $buku->kategori }}</span>
                        ...
                        <p class="text-muted mb-0" style="font-size:0.75rem;">{{ $buku->penerbit }} • {{ $buku->tahun_terbit }}
                        </p>
                        <div class="mt-auto pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <small class="text-muted">Stok tersedia</small>
                                <strong
                                    class="{{ $buku->stok_tersedia > 0 ? 'text-success' : 'text-danger' }}">{{ $buku->stok_tersedia }}/{{ $buku->stok }}</strong>
                            </div>
                            @if($buku->isAvailable())
                        ...
                        <div class="modal-content" style="border-radius:16px;">
                            ...
                            <form method="POST" action="{{ route('siswa.pinjam') }}">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-6">
                                            <label class="form-label fw-semibold small">Tanggal Pinjam <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="tanggal_pinjam" class="form-control"
                                                value="{{ date('Y-m-d') }}" min="{{ date('Y-m-d') }}" required>
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-semibold small">Tanggal Kembali <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="catatan" class="form-control" rows="2"
                                                placeholder="Keperluan pinjam..."></textarea>
                                        </div>
                                    </div>
